...
L_earliest = 100000000000000
#next_883_bus = L_earliest - L_earliest%(883*19) + 883*19
start = (L_earliest//(883*19)+1)*883*19
end   = start*100

#t0 = (i   -19)%19  ==0  # 19
#t1 = (i+13-19)%37  ==0  # 37
#t2 = (i+19-19)%883 ==0  # 883
#t3 = (i+27-19)%23  ==0  # 23
#t4 = (i+32-19)%13  ==0  # 13
#t5 = (i+36-19)%17  ==0  # 17
#t6 = (i+50-19)%797 ==0  # 797
#t7 = (i+60-19)%41  ==0  # 41
#t8 = (i+79-19)%29  ==0  # 29
...
for i in range(start, end, 883*19):
    if   (i+31)%797!=0: # 797
        ...
        print('Offset departures starts with 1st bus at:', i-19)
        break

print('sorry, not found.  last t:', i)
